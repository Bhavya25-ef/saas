...
const features = [
  {
    ...
    description: "Auto-organize files and trigger actions on file changes",
  },
  {
    icon: "💬",
  ...
  },
  {
    ...
    description: "Create and update Notion entries automatically",
  },
  {
    icon: "💳",
    title: "Stripe Payments",
    description: "Charge customers with subscriptions",
  },
  {
    icon: "📊",
